...
# --------- Paths and Filename ----------
file_name = "updated_full_track_pinch_no_GPIO6.py"
...
def main():
    ...
    while True:
        ...
        too_wild = (vel_med > VEL_THRESH_DEG_S * 100000.0) or (pos_std > POS_STD_THRESH_PX * 100000.0)
        ...
        if DRAW_FRAME_RT:
            ...
            cv2.putText(frame, "Pinch -> track fingertip | Fist -> face track", (10, 144),
                        cv2.FONT_HERSHEY_SIMPLEX, 0.55, (255,255,255), 2, cv2.LINE_AA)
