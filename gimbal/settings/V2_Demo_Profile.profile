<saved-configuration>
  <board-params>
    ...
    <general__flags2>34823</general__flags2>
    <general__flags3>32768</general__flags3>
    <general__flags4>0</general__flags4>
    <encoder__types>
      <int>0</int>
      <int>0</int>
      <int>0</int>
    ...
    <auto__pid__cfg>122</auto__pid__cfg>
    <auto__pid__precision>0</auto__pid__precision>
    <auto__pid__momentum>255</auto__pid__momentum>
    ...
    <CAN__Drv__soft__params>
      <can-drv-params>
        <format__ver>0</format__ver>
        <R__stator>0</R__stator>
        <Ld__stator>1.0</Ld__stator>
        <LqLd__ratio>127</LqLd__ratio>
        <current__PI__ratio>127</current__PI__ratio>
        <current__PI__Wc>50</current__PI__Wc>
        ...
        <flags>0</flags>
        <scale__speed>0</scale__speed>
        <scale__angle>0</scale__angle>
        <limit__angle__min>0</limit__angle__min>
        <limit__angle__max>0</limit__angle__max>
        <acc__limit>137</acc__limit>
        <jerk__slope__ms>0</jerk__slope__ms>
        <default__speed>137</default__speed>
        <search__home__acc>137</search__home__acc>
        <search__home__speed>137</search__home__speed>
        <servoRate>50</servoRate>
        <servoOut>
          <int>0</int>
          <int>0</int>
        </servoOut>
        <setpointLPF>2000</setpointLPF>
        <flags2>0</flags2>
        <reserved>
          <byte>0</byte>
          <byte>0</byte>
    ...
    <ext__buzzer__pin>0</ext__buzzer__pin>
    ...
    <ext__sens__calib__val>0.0</ext__sens__calib__val>
    <ext__sens__params__reserved>
      <byte>0</byte>
      <byte>0</byte>
      <byte>0</byte>
      <byte>0</byte>
    ...
    <tripod__mode__auto__threshold>20</tripod__mode__auto__threshold>
    ...
    <geometry__cfg>
      ...
      <split__receiver__origin>0</split__receiver__origin>
      <split__receiver__offset>
        <int>0</int>
        <int>0</int>
        <int>0</int>
      </split__receiver__offset>
      <split__receiver__mag__origin>0</split__receiver__mag__origin>
      <split__receiver__mag__axis__top>0</split__receiver__mag__axis__top>
      <split__receiver__mag__axis__right>0</split__receiver__mag__axis__right>
    ...
    <can__imu__servo__out>
      <int>0</int>
      <int>0</int>
    </can__imu__servo__out>
    <can__imu__servo__rate>0</can__imu__servo__rate>
    <ext__switch__shunt__r>0</ext__switch__shunt__r>
  </board-params>
  <profile>
    <P>
      <int>65</int>
    ...
    <profile__flags3>0</profile__flags3>
    <outerP>
      <int>50</int>
      <int>50</int>
      <int>50</int>
    ...
    <shakeGenerator>
      ...
      <freq>0</freq>
      <freq__range>0</freq__range>
      <pause__period>0</pause__period>
      <pause__balance>0</pause__balance>
      <pause__affection>0</pause__affection>
      <pause__randomness>0</pause__randomness>
      <pause__phase__variance>0</pause__phase__variance>
      <resonance__gain>
        <int>0</int>
        <int>0</int>
        <int>0</int>
      </resonance__gain>
      <resonance__freq>0</resonance__freq>
      <freq__shift>
        <int>0</int>
        <int>0</int>
        <int>0</int>
      </freq__shift>
      <master__gain>0</master__gain>
      <reserved>
        <byte>0</byte>
        <byte>0</byte>
        <byte>0</byte>
    ...
    <servo__outerP__gain>0.1</servo__outerP__gain>
    <servo__outerI>0.0</servo__outerI>
  </profile>
  <firmwareVer>2723</firmwareVer>
  <buildNumber>20</buildNumber>
  <appVer>2740</appVer>
  <boardVer>30</boardVer>
  <boardFeatures>4891953311</boardFeatures>
</saved-configuration>